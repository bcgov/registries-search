...
// month / year menus
const selectRef:Ref<HTMLInputElement | null> = ref(null)
const yearRef:Ref<ComponentPublicInstance<HTMLInputElement>[] | null> = ref(null)
...
// max/min
const maxDate: Ref<Date | undefined> = ref(props.setMaxDate || undefined)
watch(() => props.setMaxDate, val => (maxDate.value = val))

const minDate: Ref<Date | undefined> = ref(props.setMinDate || undefined)
