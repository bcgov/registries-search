...
/**
   ...
   */
export function dateToPacificDate(date: Date, longMonth = false, showWeekday = false): string | undefined {
 ...
 */
export function dateToPacificTime(date: Date): string | undefined {
  if (!(date instanceof Date && !isNaN(date.valueOf()))) {
    return undefined
  }
 ...
 */
export function dateToPacificDateTimeShort(date: Date): string | undefined {
 ...
 */
export function apiToPacificDateTime(dateTimeString: string, longMonth = false): string | undefined {
 ...
 */
export function apiToDate(dateTimeString: string): Date | undefined {
  if (!dateTimeString) {
    return undefined
  }
