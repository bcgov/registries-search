export enum PersonControlType {
  DIRS_DIRECT = 'controlType.directors.directControl',
  DIRS_INCONCERT = 'controlType.directors.inConcertControl',
  DIRS_INDIRECT = 'controlType.directors.indirectControl',
  DIR_JOINTLY = 'controlType.directors.actingJointly',
  DIRS_SIG_INFL = 'controlType.directors.significantInfluence',
