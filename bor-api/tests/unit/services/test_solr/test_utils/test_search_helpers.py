...
BASIC_PAYLOAD = expected_payload = {
    'query': '(legalName_q:name^2 OR legalName_q:name~2 OR legalName_agro_q:name^2 OR legalName_agro_q:name~2 OR legalName_single_term:name^2 OR legalName_single_term:name~2 OR identifier_q:name^2 OR identifier_q:name~1 OR bn_q:name^2 OR bn_q:name~1 OR ({!parent which = \'-_nest_path_:* entityType:*\'}address_q:name~1)) OR (legalName_q:"name"~5^5) OR (legalName_agro_q:"name"~10^3) OR (legalName_agro_q:"name"^2)',
    'filter': [],
...
COMPLEX_PAYLOAD = {
    'query': '(legalName_q:name1^2 OR legalName_q:name1~2 OR legalName_agro_q:name1^2 OR legalName_agro_q:name1~2 OR legalName_single_term:name1^2 OR legalName_single_term:name1~2 OR (identifier_q:"1" AND identifier_q:"NAME")^2 OR (identifier_q:"1" AND identifier_q:"NAME")~1 OR bn_q:name1^2 OR bn_q:name1~1 OR ({!parent which = \'-_nest_path_:* entityType:*\'}address_q:name1~1)) AND (legalName_q:name2^2 OR legalName_q:name2~2 OR legalName_agro_q:name2^2 OR legalName_agro_q:name2~2 OR legalName_single_term:name2^2 OR legalName_single_term:name2~2 OR (identifier_q:"2" AND identifier_q:"NAME")^2 OR (identifier_q:"2" AND identifier_q:"NAME")~1 OR bn_q:name2^2 OR bn_q:name2~1 OR ({!parent which = \'-_nest_path_:* entityType:*\'}address_q:name2~1)) AND (legalName_q:name3^2 OR legalName_q:name3~2 OR legalName_agro_q:name3^2 OR legalName_agro_q:name3~2 OR legalName_single_term:name3^2 OR legalName_single_term:name3~2 OR (identifier_q:"3" AND identifier_q:"NAME")^2 OR (identifier_q:"3" AND identifier_q:"NAME")~1 OR bn_q:name3^2 OR bn_q:name3~1 OR ({!parent which = \'-_nest_path_:* entityType:*\'}address_q:name3~1)) OR (legalName_q:"name1 name2 name3"~5^5) OR (legalName_agro_q:"name1 name2 name3"~10^3) OR (legalName_agro_q:"name1"^2)',
