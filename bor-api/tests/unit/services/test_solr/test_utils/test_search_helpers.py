...
BASIC_PAYLOAD = expected_payload = {
    ...
    'facet': {'entityType': {'type': 'terms', 'field': 'entityType'},
                ...
                'roleType': {'type': 'terms',
                            ...
                            'domain': {'blockChildren': '{!v=$parents}'},
                            'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}},
    'fields': ['bn', 'bnSP', 'entityAddresses', 'entityType', 'identifier', 'legalName', 'legalType', 'operatingName', 'roles', 'state', 'score', '[child]', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'active', 'relatedBN', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleDates', 'roleType', 'relatedLegalType', 'start', 'end']}
