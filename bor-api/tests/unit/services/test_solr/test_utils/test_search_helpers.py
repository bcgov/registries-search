...
BASIC_PAYLOAD = expected_payload = {
    ...
    'facet': {'entityType': {'type': 'terms', 'field': 'entityType'},
                ...
                'roleType': {'type': 'terms',
                            ...
                            'domain': {'blockChildren': '{!v=$parents}'},
                            'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}},
    'fields': ['bn', 'email', 'entityAddresses', 'entityType', 'identifier', 'legalName', 'legalType', 'roles', 'state', 'score', '[child]', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'active', 'relatedBN', 'relatedEmail', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleDates', 'roleType', 'relatedLegalType', 'start', 'end']}
