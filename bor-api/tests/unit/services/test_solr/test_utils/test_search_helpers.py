...
BASIC_PAYLOAD = expected_payload = {
    'query': '(legalName_q:name^2 OR legalName_q:name~2 OR legalName_agro_q:name^2 OR legalName_agro_q:name~2 OR legalName_single_term:name^2 OR legalName_single_term:name~2 OR operatingName_single_term:name^2 OR operatingName_single_term:name~2 OR operatingName_agro_q:name^2 OR operatingName_agro_q:name~2 OR operatingName:name^2 OR operatingName:name~2 OR identifier_q:name^2 OR identifier_q:name~1 OR bn_q:name^2 OR bn_q:name~1) OR (legalName_q:"name"~5^5) OR (legalName_agro_q:"name"~10^3) OR (legalName_agro_q:"name"^2)',
    'filter': [],
    ...
    'facet': {'entityType': {'type': 'terms', 'field': 'entityType'},
                ...
                'addressCity': {'type': 'terms',
                                'field': 'addressCity',
                                'domain': {'blockChildren': '{!v=$parents}'},
                                'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}},
                'addressCountry': {'type': 'terms',
                                    'field': 'addressCountry',
                                    'domain': {'blockChildren': '{!v=$parents}'},
                                    'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}},
                'addressRegion': {'type': 'terms',
                                'field': 'addressRegion',
                                'domain': {'blockChildren': '{!v=$parents}'},
                                'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}},
...
COMPLEX_PAYLOAD = {
    'query': '(legalName_q:name1^2 OR legalName_q:name1~2 OR legalName_agro_q:name1^2 OR legalName_agro_q:name1~2 OR legalName_single_term:name1^2 OR legalName_single_term:name1~2 OR operatingName_single_term:name1^2 OR operatingName_single_term:name1~2 OR operatingName_agro_q:name1^2 OR operatingName_agro_q:name1~2 OR operatingName:name1^2 OR operatingName:name1~2 OR (identifier_q:"1" AND identifier_q:"NAME")^2 OR (identifier_q:"1" AND identifier_q:"NAME")~1 OR bn_q:name1^2 OR bn_q:name1~1) AND (legalName_q:name2^2 OR legalName_q:name2~2 OR legalName_agro_q:name2^2 OR legalName_agro_q:name2~2 OR legalName_single_term:name2^2 OR legalName_single_term:name2~2 OR operatingName_single_term:name2^2 OR operatingName_single_term:name2~2 OR operatingName_agro_q:name2^2 OR operatingName_agro_q:name2~2 OR operatingName:name2^2 OR operatingName:name2~2 OR (identifier_q:"2" AND identifier_q:"NAME")^2 OR (identifier_q:"2" AND identifier_q:"NAME")~1 OR bn_q:name2^2 OR bn_q:name2~1) AND (legalName_q:name3^2 OR legalName_q:name3~2 OR legalName_agro_q:name3^2 OR legalName_agro_q:name3~2 OR legalName_single_term:name3^2 OR legalName_single_term:name3~2 OR operatingName_single_term:name3^2 OR operatingName_single_term:name3~2 OR operatingName_agro_q:name3^2 OR operatingName_agro_q:name3~2 OR operatingName:name3^2 OR operatingName:name3~2 OR (identifier_q:"3" AND identifier_q:"NAME")^2 OR (identifier_q:"3" AND identifier_q:"NAME")~1 OR bn_q:name3^2 OR bn_q:name3~1) OR (legalName_q:"name1 name2 name3"~5^5) OR (legalName_agro_q:"name1 name2 name3"~10^3) OR (legalName_agro_q:"name1"^2)',
    'filter': ['(identifier_q:"12345" AND identifier_q:"BC")', 'legalName_single_term:Test', 'state:("ACTIVE" OR "HISTORICAL")', 'entityType:("PERSON" OR "BUSINESS")', "({!parent which = '-_nest_path_:* entityType:*'}address_q:vancouver AND {!parent which = '-_nest_path_:* entityType:*'}address_q:bc AND {!parent which = '-_nest_path_:* entityType:*'}SolrField.RELATED_BN_Q:123)", '{!parent which = \'-_nest_path_:* entityType:*\'}addressCity:"NORTH VANCOUVER" OR addressCity: "VICTORIA"', '{!parent which = \'-_nest_path_:* entityType:*\'}relatedState:"ACTIVE"', "{!parent which = '-_nest_path_:* entityType:*'}start:[2022-03-21 TO *] OR end:[2022-03-21 TO *] OR active: true"],
    'queries': {'parents': 'entityType:*', 'parentFilters': '(identifier_q:"12345" AND identifier_q:"BC") AND legalName_single_term:Test'},
    'facet': {'entityType': {'type': 'terms', 'field': 'entityType'}, 'legalType': {'type': 'terms', 'field': 'legalType'}, 'state': {'type': 'terms', 'field': 'state'}, 'addressCity': {'type': 'terms', 'field': 'addressCity', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}, 'addressCountry': {'type': 'terms', 'field': 'addressCountry', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}, 'addressRegion': {'type': 'terms', 'field': 'addressRegion', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}, 'relatedEntityType': {'type': 'terms', 'field': 'relatedEntityType', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}, 'relatedLegalType': {'type': 'terms', 'field': 'relatedLegalType', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}, 'relatedState': {'type': 'terms', 'field': 'relatedState', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}, 'roleType': {'type': 'terms', 'field': 'roleType', 'domain': {'blockChildren': '{!v=$parents}'}, 'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}},
    'fields': ['bn', 'bnSP', 'entityAddresses', 'entityType', 'identifier_q', 'legalName', 'legalType', 'operatingName', 'roles', 'state', 'score', '[child]', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'active', 'relatedBN', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleDates', 'roleType', 'start', 'end']}
