...
@pytest.mark.parametrize('test_name,access,expected', [
    ...
    ('test_extended', SearchAccessLevel.EXTENDED, ['birthDate', 'entityType', 'legalName', 'nationalities', 'roles', 'score', '[child]', 'relatedBN', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleType', 'relatedLegalType', 'entityAddresses', 'relatedEmail', 'roleDates', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'streetAdditional', 'locationDescription', 'active', 'start', 'end', 'alternateName', 'email', 'isPermanentResident', 'externalInfluence', 'taxNumber', 'taxResidencies', 'relatedAddresses', 'relatedInterests', 'details', 'directOrIndirect', 'otherReason', 'sharesExact', 'sharesMax', 'sharesMin', 'interestType'])
])
