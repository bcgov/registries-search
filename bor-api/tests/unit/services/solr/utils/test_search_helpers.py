...
BASIC_PAYLOAD_EXTENDED = {
    ...
    'facet': {
                ...
                'roleType': {'type': 'terms',
                            ...
                            'domain': {'blockChildren': '{!v=$parents}'},
                            'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}},
    'fields': ['birthDate', 'entityType', 'legalName', 'nationalities', 'roles', 'score', '[child]', 'relatedBN', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleType', 'relatedLegalType', 'entityAddresses', 'relatedEmail', 'roleDates', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'streetAdditional', 'locationDescription', 'active', 'start', 'end', 'alternateName', 'email', 'isPermanentResident', 'externalInfluence', 'phoneNumber', 'taxNumber', 'taxResidencies', 'relatedAddresses', 'relatedInterests', 'details', 'directOrIndirect', 'otherReason', 'sharesExact', 'sharesMax', 'sharesMin', 'interestType', 'relatedParties', 'interestPartyID', 'interestPartyName']}
