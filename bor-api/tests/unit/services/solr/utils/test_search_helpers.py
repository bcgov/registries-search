...
BASIC_PAYLOAD = {
    ...
    'facet': {
                ...
                'roleType': {'type': 'terms',
                            ...
                            'domain': {'blockChildren': '{!v=$parents}'},
                            'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}},
    'fields': ['email', 'entityAddresses', 'entityType', 'legalName', 'roles', 'score', '[child]', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'locationDescription', 'relatedBN', 'relatedEmail', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleDates', 'roleType', 'relatedLegalType', 'active', 'start', 'end']}
...
BASIC_PAYLOAD_EXTENDED = {
    ...
    'facet': {
                ...
                'roleType': {'type': 'terms',
                            ...
                            'domain': {'blockChildren': '{!v=$parents}'},
                            'facet': {'by_parent': 'uniqueBlock({!v=$parents})'}}},
    'fields': ['email', 'entityAddresses', 'entityType', 'legalName', 'roles', 'score', '[child]', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'locationDescription', 'relatedBN', 'relatedEmail', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleDates', 'roleType', 'relatedLegalType', 'active', 'start', 'end', 'alternateName', 'birthDate', 'email', 'isPermanentResident', 'nationalities', 'externalInfluence', 'taxNumber', 'taxResidencies', 'relatedInterests', 'details', 'directOrIndirect', 'otherReason', 'sharesExact', 'sharesMax', 'sharesMin', 'interestType']}
