...
TEST_BUSINESSES = [
    ...
    create_entity(
        name="single", bn="242217", entity_id="BC0000067", legal_type="BEN", entity_type="BUSINESS", state="ACTIVE"
    ),
    create_entity(
        name="lots of words in here",
        bn="124221",
        entity_id="BC0000007",
        legal_type="BEN",
        entity_type="BUSINESS",
...
TEST_PERSONS = [
    ...
    create_entity(
        ...
        roles=[
            EntityRole(
                id=f"SI9{TEST_BUSINESSES[6].identifier}SIGNIFICANT_INDIVIDUAL",
                relatedAddresses=[
                    Address(
                        addressCity="Fake",
                        addressCountry="Canada",
                ...
                relatedEmail=TEST_BUSINESSES[6].email,
                relatedEntityType="BUSINESS",
                relatedIdentifier=TEST_BUSINESSES[6].identifier,
                relatedLegalType=TEST_BUSINESSES[6].legalType,
                ...
                relatedInterests=[
                    ...
                    Interest(
                        ...
                        sharesMax=50,
                        sharesMin=25,
                        relatedParties=[InterestParty("1111", "PartyName 1")],
                    ),
                    Interest(
                        ...
                        sharesMax=50,
                        sharesMin=25,
                        relatedParties=[InterestParty("2222", "PartyName 2")],
                    ),
                ],
            )
        ],
    ...
    create_entity(
        ...
        roles=[
            EntityRole(
                id=f"SI10{TEST_BUSINESSES[7].identifier}SIGNIFICANT_INDIVIDUAL",
                relatedAddresses=[
                    Address(
                        addressCity="Sidney",
                        addressCountry="Canada",
    ...
    create_entity(
        ...
        roles=[
            EntityRole(
                id=f"SI11{TEST_BUSINESSES[7].identifier}SIGNIFICANT_INDIVIDUAL",
                relatedBN=TEST_BUSINESSES[7].bn,
                relatedEmail=TEST_BUSINESSES[7].email,
                relatedEntityType="BUSINESS",
                relatedIdentifier=TEST_BUSINESSES[7].identifier,
                ...
                relatedInterests=[
                    ...
                    Interest(
                        ...
                        sharesMax=50,
                        sharesMin=25,
                        relatedParties=[InterestParty("3333", "PartyName 3")],
                    ),
                ],
            )
        ],
