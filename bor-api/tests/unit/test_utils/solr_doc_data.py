...
TEST_PERSONS = [
    ...
    create_entity(name='person eight',
                  ...
                  roles=[EntityRole(id='LEAR8/roles0',
                                    relatedAddresses=[Address(addressCity='Calgary',
                                                              addressCountry='Canada',
                                                              addressRegion='AB',
                                                              addressType='DELIVERY',
    ...
    create_entity(name='person ten y.z. xk',
                  ...
                  roles=[EntityRole(id=f'SI10{TEST_BUSINESSES[7].identifier}SIGNIFICANT_INDIVIDUAL',
                                    relatedAddresses=[Address(addressCity='Sidney',
                                                              addressCountry='Canada',
                                                              addressRegion='BC',
                                                              addressType='DELIVERY',
    ...
    create_entity(name='p!e(rs)on e}l{ev-en ~`@#$%^-_=[]|\\;:\'",<>./',
                  ...
                  entity_id='SI11',
                  nationalities=['CA'],
                  roles=[EntityRole(id=f'SI11{TEST_BUSINESSES[7].identifier}SIGNIFICANT_INDIVIDUAL',
                                    relatedBN=TEST_BUSINESSES[7].bn,
                                    relatedEmail=TEST_BUSINESSES[7].email,
                                    relatedEntityType='BUSINESS',
                                    relatedIdentifier=TEST_BUSINESSES[7].identifier,
