    ...
    "parties": [
        {
            ...
            "roles": [{"appointmentDate": "2023-03-06", "cessationDate": None, "roleType": "Director"}],
            "source": "LEAR",
        },
        {
            "deliveryAddress": {
            ...
            "officer": {"email": None, "firstName": "BLIPPITY", "id": 570721, "lastName": "BOP", "partyType": "person"},
            "roles": [{"appointmentDate": "2023-03-20", "cessationDate": None, "roleType": "Director"}],
            "source": "LEAR",
        },
    ],
}
    ...
    "owners": [
        {
            "interestedParty": {
                ...
                "hasTaxNumber": True,
                "identifiers": [{"id": "402 931 299", "scheme": "CAN-TAXID", "schemeName": "ITN"}],
                "isPermanentResidentCa": False,
                "missingInfoReason": "",
                "names": [
                    {"fullName": "Kial Jinnah", "type": "individual"},
                    {"fullName": "wallaby willow", "type": "alternative"},
                ],
                ...
                "taxResidencies": [{"code": "CA", "name": "Canada"}],
                "uuid": "123xxx-456xxx",
            },
            "interests": [
                {
                ...
                },
                {
                    ...
                    "directOrIndirect": "direct",
                    "share": {"exclusiveMaximum": False, "maximum": 50, "minimum": 25},
                    "startDate": "2020-01-01",
                    "type": "votingRights",
                },
                {
                ...
                },
                {
                    ...
                    "directOrIndirect": "direct",
                    "share": {"exclusiveMaximum": False, "maximum": 75, "minimum": 50},
                    "startDate": "2020-01-01",
                    "type": "shareholding",
                },
                {
                ...
                {"details": "bla bla", "startDate": "2024-02-07", "type": "otherInfluenceOrControl"},
            ],
        }
    ],
}
