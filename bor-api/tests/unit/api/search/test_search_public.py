...
def test_search_solr_mock(app, session, client, jwt, requests_mock, test_name, query, categories):
    ...
    assert resp_json["searchResults"]["queryInfo"]["categories"] == {
        "roles": {
            ...
            "roleType": categories.get(EntityField.ROLES.value, {}).get(
                EntityRoleField.ROLE_TYPE.value, expected_default_role_types
            ),
        }
    }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"value": "person one", EntityField.ROLES.value: {"value": "CP123 test"}},
            {},
            [
                {
                    "entityType": "PERSON",
        ...
        (
            ...
            {"value": "person ten", EntityField.ENTITY_ADDRESSES.value: "victoria canada walaby way 1112 T3S 1E4"},
            {},
            [
                {
                    "birthDate": "1954",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "test_invalid_role_types_director",
            {"value": "a"},
            {"roles": {"roleType": ["DIRECTOR"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
                }
            ],
        ),
        (
            "test_invalid_role_types_incorporator",
            {"value": "a"},
        ...
        (
            "test_invalid_role_types_officer",
            {"value": "a"},
        ...
        (
            "test_invalid_role_types_attorney",
            {"value": "a"},
            {"roles": {"roleType": ["ATTORNEY"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
        ...
        (
            "test_invalid_role_types_applicant",
            {"value": "a"},
        ...
        (
            "test_invalid_role_types_reccustodian",
            {"value": "a"},
            {"roles": {"roleType": ["REC CUSTODIAN"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
        ...
        (
            "test_invalid_role_types_completingparty",
            {"value": "a"},
        ...
        (
            "test_invalid_role_types_receivermanager",
            {"value": "a"},
            {"roles": {"roleType": ["RECEIVER MGR"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
        ...
        (
            "test_invalid_role_types_custodian",
            {"value": "a"},
        ...
        (
            "test_invalid_role_types_liquidator",
            {"value": "a"},
            {"roles": {"roleType": ["LIQUIDATOR"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
        ...
        (
            "test_invalid_role_types_firmcompparty",
            {"value": "a"},
            {"roles": {"roleType": ["FIRM COMPLETING PARTY"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
        ...
        (
            "test_invalid_role_types_manager",
            {"value": "a"},
        ...
        (
            "test_invalid_role_types_nonsense",
            {"value": "a"},
            {"roles": {"roleType": ["bla"]}},
            {},
            [
        ...
        (
            "test_invalid_role_types_combined_with_valid",
            {"value": "a"},
            {"roles": {"roleType": ["PARTNER", "bla"]}},
            {},
            [
                {
                    "invalid payload": "Unexpected values provided for 'categories/roles/roleType': Accepted values are 'PARTNER', 'PROPRIETOR', and 'SIGNIFICANT INDIVIDUAL'. Other role types are not available."
...
def test_search_nationalities_only_ca_returned(app, session, client, jwt, requests_mock):
    ...
    requests_mock.post(
        f"{app.config.get('SOLR_SVC_LEADER_URL')}/bor/query",
        json={"response": {"docs": [{"nationalities": ["CA", "US"]}], "numFound": 0, "start": 0}},
    )
    # call search
    resp = client.post(
        f"/api/v1/search/public",
