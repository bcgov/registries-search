...
@pytest.mark.parametrize('test_name,query,categories,expected', [
    ...
    ('test_basic_name_match_spec_char',
     ...
     {},
     [{'alternateName': '#special"char`', 'email': 'eleven@si11.com', 'entityAddresses': [{'addressCity': 'Vancouver', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'locationDescription': 'location desc 11', 'postalCode': 'V3V 4T6', 'score': 0.0, 'streetAddress': 'Willaby Way'}], 'entityType': 'PERSON', 'legalName': 'p!e(rs)on e}l{ev-en ~`@#$%^-_=[]|\\;:\'",<>./', 'nationalities': ['CA'], 'roles': [{'relatedBN': '1255323221', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'BC0020047', 'relatedInterests': [{'details': 'controlType.sharesOrVotes.beneficialOwner', 'directOrIndirect': 'direct', 'interestType': 'voting', 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}], 'relatedLegalType': 'BEN', 'relatedName': 'NOt Case SENSitive', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2021-01-19T00:05:54Z'}], 'roleType': 'SIGNIFICANT INDIVIDUAL', 'score': 0.0}], 'taxNumber': '111 442 356'}]
    ),
    ...
    ('test_child_categories_3',
     ...
     {
        EntityField.ROLES.value: {
            EntityRoleField.RELATED_INTERESTS.value: ['controlType.sharesOrVotes.registeredOwner', 'controlType.sharesOrVotes.beneficialOwner'],
        }
     },
     [
        {'alternateName': 'significant individual alt', 'email': 'nine@si9.com', 'entityAddresses': [{'addressCity': 'Vancouver', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V6V 1P2', 'score': 0.0, 'streetAddress': 'hello world 500'}], 'entityType': 'PERSON', 'legalName': 'person nine', 'nationalities': ['CA', 'US', 'FR'], 'roles': [{'relatedAddresses': [{'addressCity': 'Fake', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V3C 3X9', 'score': 0.0, 'streetAddress': '9999 related address'}], 'relatedBN': '124221', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'BC0000007', 'relatedInterests': [{'details': 'controlType.sharesOrVotes.registeredOwner', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}], 'relatedLegalType': 'BEN', 'relatedName': 'lots of words in here', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2019-03-09T00:03:54Z'}], 'roleType': 'SIGNIFICANT INDIVIDUAL', 'score': 0.0}], 'taxNumber': '705 362 853'},
...
def test_search_fields(app, session, client, jwt, monkeypatch):
    ...
    with requests_mock.mock() as m:
        ...
        assert fields_requested == ['birthDate', 'entityType', 'legalName', 'nationalities', 'roles', 'score', '[child]', 'relatedBN', 'relatedEntityType', 'relatedIdentifier', 'relatedName', 'relatedState', 'roleType', 'relatedLegalType', 'entityAddresses', 'relatedEmail', 'roleDates', 'addressCity', 'addressCountry', 'addressRegion', 'addressType', 'postalCode', 'streetAddress', 'streetAdditional', 'locationDescription', 'active', 'start', 'end', 'alternateName', 'email', 'isPermanentResident', 'externalInfluence', 'taxNumber', 'taxResidencies', 'relatedAddresses', 'relatedInterests', 'details', 'directOrIndirect', 'otherReason', 'sharesExact', 'sharesMax', 'sharesMin', 'interestType']
