...
@pytest.mark.parametrize('test_name,query,categories,expected', [
    ...
    ('test_basic_name_match_partial_2',
     ...
     [{'entityAddresses': [{'addressCity': 'Victoria', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'T3R 43R', 'score': 0.0, 'streetAddress': 'charles place 4W2'}], 'entityType': 'PERSON', 'legalName': 'persons two', 'roles': [{'relatedBN': 'BN00012334', 'relatedEmail': 'abcd@email.com', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'CP1234567', 'relatedLegalType': 'CP', 'relatedName': 'test 1234', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2019-08-04T00:03:54Z'}], 'roleType': 'DIRECTOR', 'score': 0.0}]},
      {'entityAddresses': [{'addressCity': 'Bowen Island', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V8T 4R8', 'score': 0.0, 'streetAddress': 'Cherry Lane'}], 'entityType': 'PERSON', 'legalName': 'person twelve proprietor', 'roles': [{'relatedBN': '987654321BC0001', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'FM1234567', 'relatedLegalType': 'SP', 'relatedName': 'Firm SP', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2023-04-09T00:03:54Z'}], 'roleType': 'PROPRIETOR', 'score': 0.0}]}]
    ),
    ...
    ('test_basic_name_match_spellcheck',
     ...
     [{'entityAddresses': [{'addressCity': 'Seattle', 'addressCountry': 'United States', 'addressRegion': 'WA', 'addressType': 'DELIVERY', 'postalCode': 'V3R 4E4', 'score': 0.0, 'streetAddress': 'jerry lane 9002'}], 'entityType': 'PERSON', 'legalName': 'personing three shoot', 'roles': [{'relatedBN': 'BN00012334', 'relatedEmail': 'abcd@email.com', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'CP1234567', 'relatedLegalType': 'CP', 'relatedName': 'test 1234', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2018-08-04T00:03:54Z'}], 'roleType': 'DIRECTOR', 'score': 0.0}]},
      ...
      {'entityAddresses': [{'addressCity': 'Penticton', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'F4K 3S7', 'score': 0.0, 'streetAddress': '404 Fake Street'}], 'entityType': 'PERSON', 'legalName': 'person 13 partner', 'roles': [{'relatedBN': '987654322BC0001', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'FM1234568', 'relatedLegalType': 'GP', 'relatedName': 'Firm GP', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2024-10-01T00:03:54Z'}], 'roleType': 'PARTNER', 'score': 0.0}]}]
    ),
    ...
    ('test_basic_name_match_spec_char',
     ...
     {},
     [{'alternateName': '#special"char`', 'birthDate': '1988-10-03', 'email': 'eleven@si11.com', 'entityAddresses': [{'addressCity': 'Vancouver', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'locationDescription': 'location desc 11', 'postalCode': 'V3V 4T6', 'score': 0.0, 'streetAddress': 'Willaby Way'}], 'entityType': 'PERSON', 'legalName': 'p!e(rs)on e}l{ev-en ~`@#$%^-_=[]|\\;:\'",<>./', 'nationalities': ['CA'], 'phoneNumber': '+1 (250) 245 9804', 'roles': [{'relatedBN': '1255323221', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'BC0020047', 'relatedInterests': [{'details': 'controlType.votes.beneficialOwner', 'directOrIndirect': 'direct', 'interestType': 'votingRights', 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}, {'details': 'controlType.directors.inConcertControl', 'directOrIndirect': 'direct', 'interestType': 'appointmentOfBoard', 'relatedParties': [{'interestPartyID': '3333', 'interestPartyName': 'PartyName 3', 'score': 0.0}], 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}], 'relatedLegalType': 'BEN', 'relatedName': 'NOt Case SENSitive', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2021-01-19T00:05:54Z'}], 'roleType': 'SIGNIFICANT INDIVIDUAL', 'score': 0.0}], 'taxNumber': '111 442 356'}]
    ),
    ...
    ('test_basic_name_match_._1',
     ...
     {},
     [{'alternateName': 's.i. rm', 'birthDate': '1954-12-14', 'email': 'ten@si.com', 'entityAddresses': [{'addressCity': 'Victoria', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'locationDescription': 'location desc', 'postalCode': 'V3L 4R1', 'score': 0.0, 'streetAddress': 'hi universe 1000'}], 'entityType': 'PERSON', 'legalName': 'person ten y.z. xk', 'nationalities': ['CA'], 'phoneNumber': '+44 020 4750 3344', 'roles': [{'relatedAddresses': [{'addressCity': 'Sidney', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V1L 0W1', 'score': 0.0, 'streetAddress': '1010 related address'}], 'relatedBN': '1255323221', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'BC0020047', 'relatedInterests': [{'details': 'controlType.votes.beneficialOwner', 'directOrIndirect': 'direct', 'interestType': 'votingRights', 'score': 0.0, 'sharesMax': 75.0, 'sharesMin': 50.0}, {'details': 'other', 'directOrIndirect': 'unknown', 'interestType': 'otherInfluenceOrControl', 'otherReason': 'bla bla other reason', 'score': 0.0}], 'relatedLegalType': 'BEN', 'relatedName': 'NOt Case SENSitive', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2020-11-09T00:03:54Z'}], 'roleType': 'SIGNIFICANT INDIVIDUAL', 'score': 0.0}], 'taxNumber': '104 342 350'}]
    ),
    ...
    ('test_basic_alt_name_match_exact',
     ...
     {},
     [{'alternateName': 'significant individual alt', 'birthDate': '1999-02-26', 'email': 'nine@si9.com', 'entityAddresses': [{'addressCity': 'Vancouver', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V6V 1P2', 'score': 0.0, 'streetAddress': 'hello world 500'}], 'entityType': 'PERSON', 'legalName': 'person nine', 'nationalities': ['CA', 'US', 'FR'], 'phoneNumber': '+1 (778) 445 7843', 'roles': [{'relatedAddresses': [{'addressCity': 'Fake', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V3C 3X9', 'score': 0.0, 'streetAddress': '9999 related address'}], 'relatedBN': '124221', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'BC0000007', 'relatedInterests': [{'details': 'controlType.shares.registeredOwner', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}, {'details': 'controlType.shares.actingJointly', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'relatedParties': [{'interestPartyID': '1111', 'interestPartyName': 'PartyName 1', 'score': 0.0}], 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}, {'details': 'controlType.shares.inConcertControl', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'relatedParties': [{'interestPartyID': '2222', 'interestPartyName': 'PartyName 2', 'score': 0.0}], 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}], 'relatedLegalType': 'BEN', 'relatedName': 'lots of words in here', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2019-03-09T00:03:54Z'}], 'roleType': 'SIGNIFICANT INDIVIDUAL', 'score': 0.0}], 'taxNumber': '705 362 853'}]
    ),
    ...
    ('test_basic_email_fuzzy_no_match',
     {'value': 'nane@so.com'},
     {},
     []
    ),
    ...
    ('test_filters_alt_name_no_match',
    ...
    ('test_filters_info_email_no_match',
    ...
    ('test_filters_no_match',
     {'value': 'person', 'name': 'ten', 'info': 'nine@si9.com'},
     {},
     []
    ),
    ('test_categories_1',
    ...
    ('test_categories_no_match',
     {'value': 'person'},
     {EntityField.NATIONALITIES.value: ['UK']},
     []
    ),
    ('test_child_filters',
     {
    ...
    ('test_child_filters_related_role_dates_1',
     ...
     {},
     [{'entityAddresses': [{'addressCity': 'Victoria', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V3R 1A4', 'score': 0.0, 'streetAddress': 'hello world 9002'}], 'entityType': 'PERSON', 'legalName': 'person eight', 'roles': [{'relatedAddresses': [{'addressCity': 'Calgary', 'addressCountry': 'Canada', 'addressRegion': 'AB', 'addressType': 'DELIVERY', 'postalCode': 'V2R 3A7', 'score': 0.0, 'streetAddress': '8888 related address'}], 'relatedBN': 'BN00012334', 'relatedEmail': '5555@email.com', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'CP0034567', 'relatedLegalType': 'CP', 'relatedName': 'tests 2222', 'relatedState': 'ACTIVE', 'roleDates': [{'active': False, 'end': '2016-08-04T00:03:54Z', 'score': 0.0, 'start': '2015-08-04T00:03:54Z'}], 'roleType': 'DIRECTOR', 'score': 0.0}]}]
    ),
    ...
    ('test_child_categories_4',
     ...
     {
        EntityField.ROLES.value: {
            EntityRoleField.RELATED_INTERESTS.value: ['controlType.shares.registeredOwner', 'controlType.votes.beneficialOwner'],
        }
     },
     [
        {'alternateName': 'significant individual alt', 'birthDate': '1999-02-26', 'email': 'nine@si9.com', 'entityAddresses': [{'addressCity': 'Vancouver', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V6V 1P2', 'score': 0.0, 'streetAddress': 'hello world 500'}], 'entityType': 'PERSON', 'legalName': 'person nine', 'nationalities': ['CA', 'US', 'FR'], 'phoneNumber': '+1 (778) 445 7843', 'roles': [{'relatedAddresses': [{'addressCity': 'Fake', 'addressCountry': 'Canada', 'addressRegion': 'BC', 'addressType': 'DELIVERY', 'postalCode': 'V3C 3X9', 'score': 0.0, 'streetAddress': '9999 related address'}], 'relatedBN': '124221', 'relatedEntityType': 'BUSINESS', 'relatedIdentifier': 'BC0000007', 'relatedInterests': [{'details': 'controlType.shares.registeredOwner', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}, {'details': 'controlType.shares.actingJointly', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'relatedParties': [{'interestPartyID': '1111', 'interestPartyName': 'PartyName 1', 'score': 0.0}], 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}, {'details': 'controlType.shares.inConcertControl', 'directOrIndirect': 'direct', 'interestType': 'shareholding', 'relatedParties': [{'interestPartyID': '2222', 'interestPartyName': 'PartyName 2', 'score': 0.0}], 'score': 0.0, 'sharesMax': 50.0, 'sharesMin': 25.0}], 'relatedLegalType': 'BEN', 'relatedName': 'lots of words in here', 'relatedState': 'ACTIVE', 'roleDates': [{'active': True, 'score': 0.0, 'start': '2019-03-09T00:03:54Z'}], 'roleType': 'SIGNIFICANT INDIVIDUAL', 'score': 0.0}], 'taxNumber': '705 362 853'},
...
def test_search_fields(app, session, client, jwt, monkeypatch):
    ...
    with requests_mock.mock() as m:
        ...
        assert fields_requested == [
            'birthDate', 'entityType', 'legalName', 'nationalities',
            'roles', 'score', '[child]', 'relatedBN', 'relatedEntityType',
            'relatedIdentifier', 'relatedName', 'relatedState', 'roleType',
            'relatedLegalType', 'entityAddresses', 'relatedEmail', 'roleDates',
            'addressCity', 'addressCountry', 'addressRegion', 'addressType',
            'postalCode', 'streetAddress', 'streetAdditional', 'locationDescription',
            'active', 'start', 'end', 'alternateName', 'email', 'isPermanentResident',
            'externalInfluence', 'phoneNumber', 'taxNumber', 'taxResidencies',
            'relatedAddresses', 'relatedInterests', 'details', 'directOrIndirect',
            'otherReason', 'sharesExact', 'sharesMax', 'sharesMin', 'interestType',
            'relatedParties', 'interestPartyID', 'interestPartyName'
        ]
