...
# from bor_api.enums import DocumentType, SolrDocEventStatus, SolrDocEventType
# from bor_api.models import Document, DocumentAccessRequest, SolrDoc, SolrDocEvent, User
# from bor_api.services.authz import SYSTEM_ROLE

# from tests.unit import MockResponse
# from tests.unit.utils import SOLR_TEST_DOCS, SOLR_UPDATE_REQUEST_TEMPLATE as REQUEST_TEMPLATE, create_header
# from tests import integration_solr


# uncomment / alter once solr config implemented
# @integration_solr
