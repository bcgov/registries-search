            ...
            assert m.request_history[1].json() == [
                {
                    ...
                    'roles': {'set': [{
                        ...
                        'relatedEmail': 'test@email.com',
                        'roleDates': [{'active': False, 'end': '2023-07-07', 'start': '2020-01-01'}, {'active': True, 'end': None, 'start': '2024-02-07'}],
                        'relatedName': request_json['business']['legalName'],
                        'relatedState': 'ACTIVE',
                        ...
                        'relatedEntityType': 'BUSINESS',
                        'relatedInterests': [
                            {'details': 'controlType.directors.directControl', 'sharesMax': None, 'sharesMin': None, 'otherReason': None, 'sharesExact': None, 'interestType': 'appointmentOfBoard', 'relatedParties': None, 'directOrIndirect': 'direct'},
                            {'details': 'controlType.directors.inConcertControl', 'sharesMax': None, 'sharesMin': None, 'otherReason': None, 'sharesExact': None, 'interestType': 'appointmentOfBoard', 'relatedParties': [{'interestPartyID': '111-feknfvn-3432dgg', 'interestPartyName': 'Name One'}], 'directOrIndirect': 'direct'},
                            {'details': 'controlType.directors.actingJointly', 'sharesMax': None, 'sharesMin': None, 'otherReason': None, 'sharesExact': None, 'interestType': 'appointmentOfBoard', 'relatedParties': [{'interestPartyID': '222-feknfvn-3432dgg', 'interestPartyName': 'Name Two'}], 'directOrIndirect': 'direct'},
                            {'details': 'controlType.votes.registeredOwner', 'sharesMax': 50, 'sharesMin': 25, 'otherReason': None, 'sharesExact': None, 'interestType': 'votingRights', 'relatedParties': None, 'directOrIndirect': 'direct'},
                            {'details': 'controlType.votes.indirectControl', 'sharesMax': 50, 'sharesMin': 25, 'otherReason': None, 'sharesExact': None, 'interestType': 'votingRights', 'relatedParties': None, 'directOrIndirect': 'indirect'},
                            {'details': 'controlType.votes.inConcertControl', 'sharesMax': 50, 'sharesMin': 25, 'otherReason': None, 'sharesExact': None, 'interestType': 'votingRights', 'relatedParties': [{'interestPartyID': '333-feknfvn-3432dgg', 'interestPartyName': 'Name Three'}], 'directOrIndirect': 'direct'},
                            {'details': 'controlType.shares.registeredOwner', 'sharesMax': 75, 'sharesMin': 50, 'otherReason': None, 'sharesExact': None, 'interestType': 'shareholding', 'relatedParties': None, 'directOrIndirect': 'direct'},
                            {'details': 'controlType.shares.indirectControl', 'sharesMax': 75, 'sharesMin': 50, 'otherReason': None, 'sharesExact': None, 'interestType': 'shareholding', 'relatedParties': None, 'directOrIndirect': 'indirect'},
                            {'details': 'controlType.shares.actingJointly', 'sharesMax': 75, 'sharesMin': 50, 'otherReason': None, 'sharesExact': None, 'interestType': 'shareholding', 'relatedParties': [{'interestPartyID': '444-feknfvn-3432dgg', 'interestPartyName': 'Name Four'}], 'directOrIndirect': 'direct'},
                            {'details': 'other', 'sharesMax': None, 'sharesMin': None, 'otherReason': 'bla bla', 'sharesExact': None, 'interestType': 'otherInfluenceOrControl', 'relatedParties': None, 'directOrIndirect': None}],
                        'relatedIdentifier': request_json['business']['identifier'],}]},
                    'state': None,
