...
from tests.unit.test_utils import (
    SOLR_UPDATE_REQUEST_TEMPLATE as REQUEST_TEMPLATE,
...
@pytest.mark.parametrize(
    "test_name,request_json,role_info",
    [
...
def test_update_solr_mocked(app, session, client, jwt, test_name, request_json, role_info):
    ...
    with requests_mock.mock() as m:
        ...
        business_identifier = request_json["business"]["identifier"]
        check_update_recorded(business_identifier, is_party=False, status=SolrDocEventStatus.COMPLETE)
        for party in request_json.get("parties", []):
            for role in party["roles"]:
                identifier = f"{party['source']}{party['officer']['id']}{business_identifier}{role['roleType'].replace(' ', '_')}".upper()
                        ...
                        "set": [
                            {
                                ...
                                "relatedEmail": "test@email.com",
                                "roleDates": [
                                    {"active": False, "end": "2023-07-07", "start": "2020-01-01"},
                                    {"active": True, "end": None, "start": "2024-02-07"},
                                ],
                                "relatedName": request_json["business"]["legalName"],
                                "relatedState": "ACTIVE",
                                ...
                                "relatedInterests": [
                                    ...
                                    },
                                    {
                                        ...
                                        "interestType": "appointmentOfBoard",
                                        "relatedParties": [
                                            {"interestPartyID": "111-feknfvn-3432dgg", "interestPartyName": "Name One"}
                                        ],
                                        "directOrIndirect": "direct",
                                    },
                                    {
                                        ...
                                        "interestType": "appointmentOfBoard",
                                        "relatedParties": [
                                            {"interestPartyID": "222-feknfvn-3432dgg", "interestPartyName": "Name Two"}
                                        ],
                                        "directOrIndirect": "direct",
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        "relatedParties": [
                                            {
                                                "interestPartyID": "333-feknfvn-3432dgg",
                                                "interestPartyName": "Name Three",
                                            }
                                        ],
                                        "directOrIndirect": "direct",
                                    },
                                    ...
                                    },
                                    {
                                        ...
                                        "interestType": "shareholding",
                                        "relatedParties": [
                                            {"interestPartyID": "444-feknfvn-3432dgg", "interestPartyName": "Name Four"}
                                        ],
                                        "directOrIndirect": "direct",
                                    },
                                    {
        ...
        if role_info:
            ...
            for index, role_ids in enumerate(role_info):
                assert m.request_history[2].json()[index] == {
                    ...
                    "related_q": {
                        "set": f"{request_json['business']['legalName']} {business_identifier} {request_json['business']['taxId']}"
                    },
                }
...
@integration_solr
@pytest.mark.parametrize(
    "test_name,request_json,existing_entities",
    [
...
@pytest.mark.parametrize(
    "test_name,legal_type,identifier,expected",
    [
