...
from bor_api.models import SearchHistory, User
...
def public_search():  # TODO: break this up
    ...
    try:
        ...
        categories = {
            ...
            # EntityField.NATIONALITIES: categories_json.get(EntityField.NATIONALITIES.value, None)  # noqa: ERA001
        }
        ...
        role_types = role_categories_json.get(EntityRoleField.ROLE_TYPE.value, [])
        role_categories = {
            EntityRoleField.RELATED_ENTITY_TYPE: role_categories_json.get(
            ...
            EntityRoleField.ROLE_TYPE: role_types or ["PARTNER", "PROPRIETOR", "SIGNIFICANT INDIVIDUAL"],
        ...
        response = {
            ...
            "searchResults": {
                "queryInfo": {
                    "categories": {**categories, EntityField.ROLES.value: role_categories},
                    "query": {
                        "value": query["value"],
