...
from bor_api.services.authz import user_info
...
class User(db.Model):
    ...
    creation_date = db.Column(db.DateTime(timezone=True), default=utcnow)
    ...
    @classmethod
    def find_by_id(cls, submitter_id: int | None = None):
